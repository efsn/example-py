...
driver.find_element_by_xpath('/html/body/div/div/div/div/div/form/span/input').send_keys('abc')#使用绝对路径定位元素
driver.find_element_by_xpath("//*[@id='kw']").send_keys("selenium")  # 搜索输入框输入Selenium     使用标签id定位元素
